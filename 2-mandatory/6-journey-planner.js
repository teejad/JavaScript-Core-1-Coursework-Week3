...
*/
function isAccessibleByTransportMode(transportMode , transportModes) {
  return transportMode.includes(transportModes);
}
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(transportMode) {
...
// let filtered = locations.filter(location => isAccessibleByTransportMode(location, transportMode));
// return filtered.map(index => getLocationName(location));
// // }
// function journeyPlanner(locations, transportMode) {
...
function journeyPlanner(locations, transportMode) {
  // Implement the function body
  let filtered = locations.filter(location => isAccessibleByTransportMode(location, transportMode));
  return filtered.map(location => getLocationName(location));
}
